...
import plan1 from "../assets/images/projects/image1.jpg";
import plan2 from "../assets/images/projects/image2.jpg";
import plan3 from "../assets/images/projects/image3.jpg";
import plan4 from "../assets/images/projects/image4.jpg";
import plan5 from "../assets/images/projects/image5.jpg";
import plan6 from "../assets/images/projects/image6.jpg";
    ...
    return (
      ...
      <form>
          <div class="field">
              ...
              <div class="control">
              <input class="input" type="text" placeholder="Please enter the service's name" disabled />
              </div>
          </div>
          ...
          <div class="field">
              <label class="label">Additional Information</label>
              <div class="control">
              <textarea class="textarea" placeholder="Please provide additional information about the service for the customer" disabled></textarea>
              </div>
          </div>
          ...
          <div class="field">
              <label class="label">Expiry Date</label>
              <div class="control">
              <input class="input" type="date" value="2021-02-26" disabled />
              </div>
          </div>
      ...
      <form>
          ...
          <div class="field">
              ...
              <div class="control has-icons-left has-icons-right">
              <input class="input is-danger" type="email" placeholder="Please enter the customer's email" disabled />
              <span class="icon is-small is-left">
                  <i class="fas fa-envelope"></i>
              </span>
              <span class="icon is-small is-right">
          ...
          <div class="field">
              ...
              <div class="control">
              <textarea class="textarea" placeholder="Please enter the resolution of the customer's concern(s)" disabled></textarea>
              </div>
          </div>
